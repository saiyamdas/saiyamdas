...
astraSmoothScroll = function(e, t) {
    ...
    function() {
                ...
                if (t && e) {
                    ...
                    if (void 0 === n) a.style.display = "none";
                        ...
                        if (-1 === n.className.indexOf("nav-menu") && (n.className += " nav-menu"), document.addEventListener("DOMContentLoaded", function() {
                            ...
                            for (r = 0, l = s.length; r < l; r++) s[r].addEventListener("focus", S, !0), s[r].addEventListener("blur", S, !0), s[r].addEventListener("click", L, !0)
                        }
        ...
        if (document.querySelectorAll(".search-field").forEach(e => {
            ...
            if (E)
                for (const link of E) link.href.split("#")[0] !== location.href.split("#")[0] ? t.push({
                    hash: link.hash,
